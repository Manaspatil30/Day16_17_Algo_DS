...
namespace Unordered_Linkedlist
{
    public class Node
    {
        public string data;
    ...
    class Unordered
    {
        ...
        static void Main(string[] args)
        {
            ...
            string path = @"C:\Users\Manas Patil\source\repos\DataStructure_Programs\DataStructure_Programs\TextFile1.txt";
            ...
            Console.WriteLine("Inserting from file to LinkedList :\n");
